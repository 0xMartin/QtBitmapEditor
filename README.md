...
### Zoom in/out
<div>
    <img src="./doc/zoom_in.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
    <img src="./doc/zoom_out.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
</div>
...
<img src="./doc/color_picker.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
...
<img src="./doc/pen.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">

The pencil tool is the simplest tool, allowing the user to draw on the image with the selected color and thickness.

### Eraser

<img src="./doc/eraser.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">

The eraser tool allows the user to erase pixels in the selected raster layer.

### Brush

<img src="./doc/brush.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
...
<img src="./doc/fill.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
...
<img src="./doc/text.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
...
<div>
    <img src="./doc/arrow_up.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
    <img src="./doc/arrow_down.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
</div>
...
<img src="./doc/new_layer.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
...
<img src="./doc/remove_layer.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">

The "Remove layer" button is a tool used in the layer editor panel to delete the selected layer from the image. 

### Mask create/remove

<img src="./doc/layer_mask.png" width="4%" style="background-color: #581477; padding: 10px; border-radius: 5px">
